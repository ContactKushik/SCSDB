  ...
  return (
    <div className="hidden md:block w-[20%] h-screen bg-zinc-800 border-r-2 border-zinc-600 p-5  flex flex-col overflow-hidden ">
      ...
      <nav className="flex flex-col text-xl gap-2">
        <h1 className="mt-10 font-semibold mb-2 text-[#6556CD] md:text-zinc-400 ">
          New Feeds
        </h1>
        <NavLink
          to="/trending"
      ...
      <nav className="flex flex-col  gap-2 text-xl">
        <h1 className="mt-5 font-semibold text-[#6556CD] md:text-zinc-400">
          Know Us
        </h1>
        <NavLink
          to="/about"
        ...
        <NavLink
          to="/contact"
          className="hover:bg-[#6556CD] hover:text-white px-5 text-zinc-300 rounded-md duration-200 py-3"
        >
